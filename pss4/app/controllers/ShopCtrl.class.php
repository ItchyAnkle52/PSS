...
class ShopCtrl {
    ...
    public function shop_filtered_chairs(){
        $this->validate();
    ...
    public function action_chair_list(){
        $this->shop_filtered_chairs();
        $this->generateView();
    }
    public function action_chair_list_ajax(){
        $this->shop_filtered_chairs();
    ...
    public function generateView_ajax() {
        ...
        App::getSmarty()->assign('sum', $this->sum);
        App::getSmarty()->assign('limit', $this->limit);
        App::getSmarty()->display("shop_filter.tpl");
    }
